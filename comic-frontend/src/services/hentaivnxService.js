...
const API_BASE = import.meta.env.VITE_API_BASE_URL + '/scraper/hentaivnx';
...
export const scrapeComicList = async (type = 'latest') => {
    try {
        ...
        console.error("HentaiVNX list scraper error", error);
        throw error;
    }
};
...
export const searchComic = async (query) => {
    try {
        ...
        console.error("HentaiVNX search error", error);
        throw error;
    }
};
...
export const scrapeComicDetail = async (comicUrl) => {
    try {
        ...
        console.error("HentaiVNX detail scraper error", error);
        throw error;
    }
};
...
export const scrapeChapterImages = async (chapterUrl) => {
    try {
        ...
        console.error("HentaiVNX chapter image scraper error", error);
        throw error;
    }
};
