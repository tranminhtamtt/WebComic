...
const API_BASE = import.meta.env.VITE_API_BASE_URL + '/scraper/sayhentai';
...
export const scrapeComicList = async (type = 'latest') => {
    try {
        ...
        console.error("SayHentai list scraper error", error);
        throw error;
    }
};
...
export const searchComic = async (query) => {
    try {
        ...
        console.error("SayHentai search error", error);
        throw error;
    }
};
...
export const scrapeComicDetail = async (comicUrl) => {
    try {
        ...
        console.error("SayHentai detail scraper error", error);
        throw error;
    }
};
...
export const scrapeChapterImages = async (chapterUrl) => {
    try {
        ...
        console.error("SayHentai chapter image scraper error", error);
        throw error;
    }
};
